...
export const existingUser: UserProfile = {
  notifications: {
    messages: true,
    reactions: true,
    comments: true,
  ...
  avatarImage: 'http://place-hold.it/500x500'
};

export const existingUserTwo: UserProfile = {
  notifications: {
    messages: false,
    reactions: true,
    comments: true,
...
export const existingUserThree: UserProfile = {
  notifications: {
    messages: false,
    reactions: true,
    comments: true,
...
export const existingUserFour: UserProfile = {
  notifications: {
    messages: false,
    reactions: true,
    comments: true,
